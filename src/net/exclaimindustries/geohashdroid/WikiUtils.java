...
public class WikiUtils {
  ...
  */
    public static void putWikiImage(HttpClient httpclient, String filename,
            String description, HashMap<String, String> formfields, byte[] data)
            throws WikiException {
        if (!formfields.containsKey("token")) {
            throw new WikiException(WikiException.Severity.PAUSING,
                    R.string.wiki_error_unknown);
        }
        ...
        Part[] nvps = new Part[] {
                ...
                new FilePart("file", new ByteArrayPartSource(filename, data),
                        "image/jpeg", "utf-8"), };
        ...
        if (doesResponseHaveError(root)) {
            throw new WikiException(WikiException.Severity.PAUSING,
                    getErrorTextId(findErrorCode(root)));
        }
    }
  ...
  public static void login(HttpClient httpclient, String wpName, String wpPassword) throws WikiException {
    ...
    if(result.equals("NeedToken")) {
        ...
        try {
            ...
            throw new WikiException(WikiException.Severity.PAUSING, R.string.wiki_error_xml);
        }
    }
    ...
    if(result.equals("Success")) {
        ...
        Log.d(DEBUG_TAG, "FAILURE!");
         throw new WikiException(WikiException.Severity.PAUSING, getErrorTextId(result));
     }
  }
