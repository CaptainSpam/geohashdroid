...
/**
 * The <code>GraticuleMapView</code> is a simple override of MapView to allow
 * it to know what to do with trackball events.  Which is to say, make it
 * handle the trackball BEFORE sending things off to the outline overlay.
 * 
...
public class GraticuleMapView extends MapView {
	...
	/* (non-Javadoc)
	 * @see com.google.android.maps.MapView#onTrackballEvent(android.view.MotionEvent)
	 */
	@Override
